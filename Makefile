...
$U/dump2tests2.o: $U/dump2tests.S
	$(CC) $(CFLAGS) -c -o $U/dump2tests2.o $U/dump2tests.S

$U/_dump2tests: $U/dump2tests.o $U/dump2tests2.o $(ULIB)
	$(LD) $(LDFLAGS) -N -e main -Ttext 0 -o $U/_dump2tests $U/dump2tests.o $U/dump2tests2.o $(ULIB)
